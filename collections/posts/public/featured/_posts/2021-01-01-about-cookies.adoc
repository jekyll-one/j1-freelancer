...
image:
  path:                                 /assets/images/modules/attics/1920x1280/sj.jpg
  width:                                1920
  height:                               1280
  alt:                                  Photo by SJ on Unsplash
...
#     opacity:                          0.5
      slides:
        - url:                          /assets/images/modules/attics/1920x1280/sj.jpg
          alt:                          Photo by SJ on Unsplash
          badge:
            type:                       unsplash
            author:                     SJ
            href:                       https://unsplash.com/de/@sjcbrn
---
...
The cookie allows the website to remember your actions or preferences over
time. All modern browsers support cookies, but users can set their browsers
to decline them and can delete them whenever they like. Good to know.
...
browser to store on your computer or mobile device.

...
image:
  path:                                 /assets/images/modules/attics/1920x1280/peter-herrmann.jpg
  width:                                1920
  height:                               1280
  alt:                                  Photo by Peter Herrmann on Unsplash
...
#     opacity:                          0.5
      slides:
        - url:                          /assets/images/modules/attics/1920x1280/peter-herrmann.jpg
          alt:                          Photo by Peter Herrmann on Unsplash
          badge:
            type:                       unsplash
            author:                     Peter Herrmann
            href:                       https://unsplash.com/de/@tama66
---
...
For many websites, dynamic page generation by an CMS is entirely
unnecessary and adds unwanted risks in terms of complexity, performance
losses, and security issues. Statically build web pages is often the better
solution.

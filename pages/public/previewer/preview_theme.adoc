---
title:                                  Theme
title_extention:                        Preview Bootstrap Freelancer Styles
tagline:                                Freelancer Styles
...
image:
  ...
  width:                                1920
  height:                               1280
  alt:                                  Bootstrap Theme Freelancer
...
<script>
  ...
  theme_slogans.Freelancer  = 'perfect for small businesses';

...
#
  git tag -a v2023.0.6 -m "v2023.0.6"
...
Then:
  ...
  git commit -am "New version 2023.0.6"
  git commit --allow-empty -m "New version 2023.0.6"
  git commit -am "Prepare new version 2023.0.6"
  git commit -am "Latest files of version 2023.0.6"

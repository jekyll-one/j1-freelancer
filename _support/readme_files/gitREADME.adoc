...
#
  git tag -a v2023.9.1 -m "v2023.9.1"
...
Then:
  ...
  git commit -am "New version 2023.9.1"
  git commit --allow-empty -m "New version 2023.9.1"
  git commit -am "Prepare new version 2023.9.1"
  git commit -am "Latest files of version 2023.9.1"

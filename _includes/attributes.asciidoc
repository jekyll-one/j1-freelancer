...
:icon-battery--quarter:                           icon:battery-quarter[role="md-green-700"]
:icon-battery--half:                              icon:battery-half[role="md-green-700"]
:icon-battery--three-quarter:                     icon:battery-three-quarter[role="md-green-700"]
:icon-battery--full:                              icon:battery-full[role="md-green-700"]
